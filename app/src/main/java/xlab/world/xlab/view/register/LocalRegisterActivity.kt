...
//            startActivity(intent)
    ...
    private fun observeViewModel() {
        ...
        // input data 정규식 체크 이벤트
//        registerViewModel.inputDataRegexEvent.observe(owner = this, observer = android.arch.lifecycle.Observer { inputDataRegexEvent ->
//            inputDataRegexEvent?.let { _ ->
//                inputDataRegexEvent.isRegisterBtnEnable?.let {
//                    finishBtn.isEnabled = it
//                }
//                inputDataRegexEvent.emailRegex?.let {
//                    if (it)
//                        confirmMailLayout.visibility = View.INVISIBLE
//                    else
//                        confirmMailLayout.visibility = View.VISIBLE
//                }
//                inputDataRegexEvent.passwordLengthRegex?.let {
//                    confirmPasswordLayout.visibility = View.VISIBLE
//                    textViewConfirmPasswordLength.isSelected = it
//                }
//                inputDataRegexEvent.passwordTextRegex?.let {
//                    confirmPasswordLayout.visibility = View.VISIBLE
//                    textViewConfirmPasswordText.isSelected = it
//                }
//                inputDataRegexEvent.nickNameRegex?.let {
//                    confirmNickLayout.visibility = View.VISIBLE
//                    textViewConfirmNick.isSelected = it
//                }
//            }
